...
abstract class Model {
	...
	private function connect() {
		$config = Yaf_Application::app()->getConfig()->sql;
		...
		try{
			self::$conn = new PDO($dsn, $user, $pwd, $option);
